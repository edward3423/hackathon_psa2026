...
export const PLANNED_VESSELS: PlannedVessel[] = [
  {
    ...
    name: 'MV ATLAS STAR',
    path: [
      [32.3, 31.5], [29, 33], [25, 34], [20, 34], [16, 35], [13, 36], [11.8, 37],
      [11, 37.5], [9.5, 38], [5, 38], [0, 37], [-4, 36], [-6, 35.8], [-10, 35.5],
      [-15, 32], [-18, 28], [-20, 20], [-22, 10], [-20, 0], [-15, -15], [-8, -28],
      [5, -38], [18, -38],
      [25, -38], [38, -37], [52, -30], [64, -20], [74, -8], [80, 5], [91, 7],
      [95, 7], [97, 6.5], [98.5, 5.8], [100, 4], [102, 2], [103.65, 1.15],
    ],
    speedKnots: 16.2,
